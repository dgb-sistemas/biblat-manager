    ...
    def test_document_add_view(self):
        ...
        with current_app.app_context():
            with self.client as c:
                ...
                self.assertIsInstance(context_form,
                                      forms.DocumentRegistrationForm)
    ...
    def test_document_add_insert_one(self):
        ...
        new_document_data = {
            ...
            'titulo_documento': 'Sobre el inicio de los Grundrisse de Marx: '
                                'el "Bastiat y Carey" o la necesidad de '
                                'pensar la producción en general en Enrique '
                                'Dussel.',
            ...
            'autor_corporativo-0-institucion': 'Universidad Nacional '
                                               'Autónoma de México, '
                                               'Ciudad de México. México',
            'autor_corporativo-0-dependencia': 'Facultad de Economía',
            'autor_corporativo-0-pais': 'MX',
            'resumen-0-idioma': 'spa',
            'resumen-0-resumen': 'En este trabajo se intenta proponer, '
                                 'desde los márgenes, elementos que '
                                 'cuestionen la forma tradicional de '
                                 'iniciar la lectura de los Grundrisse '
                                 'de Karl Marx y propone al mismo tiempo '
                                 'la restitución del manuscrito llamado'
                                 '“Bastiat y Carey” como su verdadero '
                                 'comienzo argumental. Ello a través de '
                                 'una revisión panorámica de su recepción '
                                 'en América Latina y en particular en la '
                                 'recepción hecha de los manuscritos de'
                                 '1857-58 de la crítica de la economía '
                                 'política por Enrique Dussel. '
                                 'Partiendo de la importancia que este '
                                 'autor latinoamericano pone sobre la'
                                 'necesidad en Marx de pensar el concepto de'
            ...
            'texto_completo': 'http://132.248.9.34/hevila/Deraizdiversa/'
                              '2017/vol4/no8/6.pdf',
        }
        create_user(user_data['email'], user_data['password'], True)
        document_add_view = url_for('main.document_add')
